        ...
        on: {
          slideChange: () => {
            if (storySlider.activeIndex === 0 || storySlider.activeIndex === 1) {
              sliderContainer.style.backgroundImage = `url("img/slide1.jpg"), linear-gradient(180deg, rgba(83, 65, 118, 0) 0%, #523E75 16.85%)`;
              slides.forEach(slide => document.body.classList.remove(slide))
              document.body.classList.add("slide1");
              ...
              slides.forEach(slide => document.body.classList.remove(slide))
              document.body.classList.add("slide4");
            }
          },
          resize: () => {
            storySlider.update();
...
/* harmony import */ var _util_typographyAnimationCalls__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./util/typographyAnimationCalls */ "./source/js/util/typographyAnimationCalls.js");
// modules
...
fullPageScroll.init();
Object(_util_typographyAnimationCalls__WEBPACK_IMPORTED_MODULE_9__["allInitialTypographyAnimationsRun"])();


/***/ }),

/***/ "./source/js/util/AccentTypographyBuildClass.js":
/*!******************************************************!*\
  !*** ./source/js/util/AccentTypographyBuildClass.js ***!
  \******************************************************/
/*! exports provided: default */
...
class AccentTypographyBuild {
  ...
  prePareText() {
    ...
    const content = text.reduce((fragmentParent, word) => {
      const wordElement = Array.from(word).reduce((fragment, letter, currentIndex) => {
        fragment.appendChild(this.createElement(letter, currentIndex));
        return fragment;
...
/***/ "./source/js/util/typographyAnimationCalls.js":
/*!****************************************************!*\
  !*** ./source/js/util/typographyAnimationCalls.js ***!
  \****************************************************/
/*! exports provided: allInitialTypographyAnimationsRun */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "allInitialTypographyAnimationsRun", function() { return allInitialTypographyAnimationsRun; });
/* harmony import */ var _AccentTypographyBuildClass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./AccentTypographyBuildClass */ "./source/js/util/AccentTypographyBuildClass.js");


const allInitialTypographyAnimationsRun = () => {
  const typographyAnimations = {
    introTitleTypographyAnimation:
      new _AccentTypographyBuildClass__WEBPACK_IMPORTED_MODULE_0__["default"](`.intro__title`, 500, `active`, `transform`),

    introDateTypographyAnimation:
      new _AccentTypographyBuildClass__WEBPACK_IMPORTED_MODULE_0__["default"](`.intro__date`, 500, `active`, `transform`),

    sliderItemTitleHistoryTypographyAnimation:
      new _AccentTypographyBuildClass__WEBPACK_IMPORTED_MODULE_0__["default"](`.slider__item-title`, 500, `active`, `transform`),

    prizesTitleTypographyAnimation:
      new _AccentTypographyBuildClass__WEBPACK_IMPORTED_MODULE_0__["default"](`.prizes__title`, 500, `active`, `transform`),
  }
